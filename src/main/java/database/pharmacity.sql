...
INSERT INTO `products` (`productID`, `name`, `category`, `trademark`, `origin`, `price`, `sale`, `orderedNumbers`, `quantity`, `dateAdded`, `content`) VALUES
	...
	(4, 'Khẩu trang y tế Famapro Extra màu trắng 4 lớp hỗ trợ ngăn khói, bụi, kháng khuẩn (50 cái)', 'Khẩu trang y tế', 'Famapro', 'Việt Nam', 39000, 100, 20, 1000, '2023-02-17', 'Khẩu trang y tế 4 lớp Famapro Extra siêu mềm mượt, nguyên liệu cao cấp, kháng khuẩn, lọc bụi mịn và chống tia UV hiệu quả.'),
