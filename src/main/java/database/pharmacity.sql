...
INSERT INTO `products` (`productID`, `categoryID`, `originID`, `quantity`, `dateAdded`, `price`, `sale`, `orderedNumbers`, `name`, `trademark`, `content`) VALUES
	...
	(16, 6, 2, 999, '2023-02-17', 300000 , 1000, 100, 'Nhiệt kế hồng ngoại CK-T1502 (EXC)', 'Trung Quốc', 'Sản phẩm này được thiết kế để đo nhiệt độ cơ thể người bằng cách thu bức xạ nhiệt hồng ngoại từ trán người, có ưu điểm là vận hành đơn giản và vệ sinh, đo nhanh và chính xác.'),
	(17, 3, 1, 999, '2023-02-17', 350000 , 1000, 100, 'Máy đo huyết áp tự động Omron HEM-7124 (Hộp 1 cái)', 'VIỆT NAM', 'Sản phẩm này được thiết kế để đo huyết áp cơ thể người bằng cách thu bức xạ nhiệt hồng ngoại từ trán người, có ưu điểm là vận hành đơn giản và vệ sinh, đo nhanh và chính xác.'),
	(18, 8, 8, 999, '2023-02-17', 275000 , 1000, 100, 'Đầu kim tiêm tiểu đường Novofine 31G (100cái/hộp - 0.25x6mm)', 'Nhật Bản', 'Khi sử dụng, gỡ miếng bảo vệ kim và vặn kim chặt vào đầu bút tiêm.'),
