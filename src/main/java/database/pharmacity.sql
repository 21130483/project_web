...
INSERT INTO `products` (`productID`, `categoryID`, `originID`, `quantity`, `dateAdded`, `price`, `sale`, `orderedNumbers`, `name`, `trademark`, `content`) VALUES
  ...
  (16, 7, 6, 999, '2023-02-17', 300000 , 1000, 100, 'Nhiệt kế hồng ngoại CK-T1502 (EXC)', 'Trung Quốc', 'Sản phẩm này được thiết kế để đo nhiệt độ cơ thể người bằng cách thu bức xạ nhiệt hồng ngoại từ trán người, có ưu điểm là vận hành đơn giản và vệ sinh, đo nhanh và chính xác.'),
  (17, 7, 6, 999, '2023-02-17', 350000 , 1000, 100, 'Máy đo huyết áp tự động Omron HEM-7124 (Hộp 1 cái)', 'VIỆT NAM', 'Sản phẩm này được thiết kế để đo huyết áp cơ thể người bằng cách thu bức xạ nhiệt hồng ngoại từ trán người, có ưu điểm là vận hành đơn giản và vệ sinh, đo nhanh và chính xác.'),
  (18, 7, 4, 999, '2023-02-17', 275000 , 1000, 100, 'Đầu kim tiêm tiểu đường Novofine 31G (100cái/hộp - 0.25x6mm)', 'Nhật Bản', 'Khi sử dụng, gỡ miếng bảo vệ kim và vặn kim chặt vào đầu bút tiêm.'),
  (19, 8, 6, 999, '2023-02-17', 2200000 , 1000, 100, 'Dụng cụ xét nghiệm nhanh COVID-19 Flowflex Test Kit (Hộp 25 bộ kit)', 'Trung Quốc', 'Flowflex SARS-CoV-2 Antigen Rapid Test giúp phát hiện nhanh kháng nguyên SARS-CoV-2 trong mẫu ngoáy dịch tỵ hầu của người nghi ngờ mắc COVID-19 trong vòng 7 ngày đầu tiên kể từ khi xuất hiện triệu chứng, sản phẩm cũng có thể xét nghiệm các mẫu bệnh phẩm của người không có triệu chứng. Sản phẩm dễ sử dụng, độ chính xác cao, có kết quả chỉ sau 15 - 30 phút và đã được Bộ Y tế cấp phép nhập khẩu theo giấy phép số 5895/BYT-TB-CT.'),
  (20, 8, 7, 999, '2023-02-17', 30000 , 1000, 90, 'Găng tay y tế có bột SH Gloves size M (Hộp 100 chiếc)', 'Thái Lan', 'Găng tay y tế có bột SH Gloves được làm từ cao su tự nhiên, chưa được tiệt trùng, có chứa tạp chất và sử dụng 1 lần. Sản phẩm có độ đàn hồi vượt trội so với găng cao su tổng hợp, đặc biệt bột trong găng giúp thao tác đeo và tháo găng dễ dàng hơn đồng thời mang lại cảm giác cầm nắm chính xác. Găng tay SH Gloves được sử dụng rộng rãi trong các hoạt động y tế.'),
